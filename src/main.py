...
def main():
    ...
    parser.add_argument(
        "--data_dir", type=str, default="raw", help="Directorio raíz de los datos"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="Número de workers para la carga de datos",
    )
    parser.add_argument(
        "--mode",
        type=str,
    ...
    if args.mode == "train" or args.mode == "both":
        ...
        train_loader = load_train_dataset(
            root_dir=data_dir, batch_size=args.batch_size, num_workers=args.num_workers
        )
